...
<<<<<<< HEAD
      :authorization_checks_enabled,:magic_guest_enabled,:workflows_enabled,:programmes_enabled, :networks_enabled, :projectless_assets_allowed,
=======
      :authorization_checks_enabled,:magic_guest_enabled,:workflows_enabled,:programmes_enabled, :friends_enabled,
>>>>>>> friends
